...
IF ~~ THEN BEGIN 27 // from: 26.1 26.0
  ...
  IF ~ReputationGT(Player1,10)
        GlobalLT("chapter","GLOBAL",16)~ THEN REPLY @56 /* #74306 */ DO ~SetGlobal("TashiaKnows","GLOBAL",2)~ GOTO 30
  IF ~ReputationGT(Player1,10)
        GlobalGT("chapter","GLOBAL",15)~ THEN REPLY @57 /* #74307 */ DO ~SetGlobal("TashiaKnows","GLOBAL",2)~ GOTO 30
  IF ~ReputationGT(Player1,10)
        GlobalLT("chapter","GLOBAL",16)~ THEN REPLY @58 /* #74306 */ DO ~SetGlobal("TashiaKnows","GLOBAL",2)~ GOTO 30
  IF ~ReputationGT(Player1,10)
        GlobalGT("chapter","GLOBAL",15)~ THEN REPLY @59 /* #74307 */ DO ~SetGlobal("TashiaKnows","GLOBAL",2)~ GOTO 30
...
IF ~~ THEN BEGIN 102 // from: 100.0
  ...
  IF ~~ THEN REPLY @223 /* #75306 */ DO ~SetGlobal("TashiaRevelation","GLOBAL",1)~ GOTO 118
  IF ~~ THEN REPLY @224 /* #74465 */ DO ~SetGlobal("TashiaRevelation","GLOBAL",2)~ GOTO 118
  IF ~~ THEN REPLY @225 /* #74466 */ DO ~SetGlobal("TashiaRevelation","GLOBAL",3)~ GOTO 118
  IF ~~ THEN REPLY @226 /* #74467 */ DO ~SetGlobal("TashiaRevelation","GLOBAL",4)~ GOTO 118
...
IF ~~ THEN BEGIN 118 // from: 103.3 103.2 103.1 103.0 102.5 102.4 102.3 102.2
  SAY @251 /* #74492 */
  IF ~~ THEN DO ~StartCutScene("Cuttas02")~ EXIT
END
...
!StateCheck(Player1,STATE_SLEEPING)~ THEN BEGIN 119 // from:
  SAY @252  /* #74493 */
  IF ~~ THEN REPLY @253 /* #74494 */ GOTO 120
  IF ~~ THEN REPLY @254 /* #74495 */ GOTO 101
END

IF ~~ THEN BEGIN 120 // from: 121.0 119.0
  SAY @255 /* #74496 */
  IF ~~ THEN REPLY @256 /* #74497 */ GOTO 117
  IF ~~ THEN REPLY @257 /* #74498 */ GOTO 123
  IF ~~ THEN REPLY @258 /* #74499 */ GOTO 131
  IF ~~ THEN REPLY @259 /* #74500 */ GOTO 135
  IF ~~ THEN REPLY @260 /* #74501 */ GOTO 139
  IF ~ReputationGT(Player1,11)~ THEN REPLY @261 /* #74502 */ GOTO 142
  IF ~ReputationLT(Player1,12)
     ReputationGT(Player1,8)~ THEN REPLY @261 /* #74502 */ GOTO 141
  IF ~~ THEN REPLY @262 /* #74503 */ GOTO 124
  IF ~GlobalGT("TashiaRevelation","GLOBAL",0)
      Global("MentionedLich","GLOBAL",0)~ THEN REPLY @263 /* #74504 */ DO ~SetGlobal("MentionedLich","GLOBAL",1)~ GOTO 121
END

IF ~~ THEN BEGIN 121 // from: 120.8
  SAY @264 /* #75309 */
  IF ~~ THEN REPLY @265 /* #74506 */ GOTO 120
  IF ~~ THEN REPLY @266 /* #74507 */ GOTO 122
  IF ~~ THEN REPLY @267 /* #74508 */ GOTO 117
END
...
IF ~~ THEN BEGIN 123 // from: 120.1
  SAY @269 /* #74510 */
  IF ~~ THEN REPLY @270 /* #74511 */ GOTO 128
  IF ~~ THEN REPLY @271 /* #74512 */ GOTO 129
  IF ~~ THEN REPLY @272 /* #74513 */ GOTO 130
END

IF ~~ THEN BEGIN 124 // from: 120.7
  SAY @273 /* #74514 */
  IF ~~ THEN REPLY @274 /* #74515 */ GOTO 125
  IF ~~ THEN REPLY @275 /* #74516 */ GOTO 126
  IF ~~ THEN REPLY @276 /* #74517 */ GOTO 127
END
...
IF ~~ THEN BEGIN 131 // from: 120.2
  ...
  IF ~OR(2)
     ...
     CheckStatGT(Player1,11,INT)~ THEN REPLY @284 /* #74525 */ GOTO 132
  IF ~~ THEN REPLY @285 /* #74526 */ GOTO 134
  IF ~~ THEN REPLY @286 /* #74527 */ GOTO 133
END
...
IF ~~ THEN BEGIN 135 // from: 120.3
  SAY @290 /* #74531 */
  IF ~~ THEN REPLY @291 /* #74532 */ GOTO 136
  IF ~~ THEN REPLY @292 /* #74533 */ GOTO 137
  IF ~~ THEN REPLY @293 /* #74534 */ GOTO 138
END
...
IF ~~ THEN BEGIN 139 // from: 120.4
  SAY @297 /* #75312 */
  IF ~~ THEN REPLY @298 /* #74539 */ GOTO 140
  IF ~~ THEN REPLY @299 /* #74540 */ GOTO 133
  IF ~ReputationLT(Player1,12)
      ReputationGT(Player1,8)~ THEN REPLY @300 /* #74541 */ GOTO 141
  IF ~ReputationGT(Player1,11)~ THEN REPLY @300 /* #74541 */ GOTO 142
  IF ~~ THEN REPLY @301 /* #74542 */ GOTO 140
END
...
IF ~~ THEN BEGIN 147 // from: 146.0
  SAY @309 /* #74550 */
  IF ~~ THEN REPLY @310 /* #40500 */ GOTO 148
  IF ~~ THEN REPLY @311 /* #74551 */ GOTO 151
END
...
GlobalGT("TashiaInterestMatch","GLOBAL",2)~ THEN BEGIN 152 // from:
  SAY @316  /* #74556 */
  IF ~~ THEN REPLY @317 /* #42810 */ GOTO 154
  IF ~~ THEN REPLY @254 /* #74495 */ GOTO 153
END
...
IF ~~ THEN BEGIN 155 // from: 154.0
  SAY @320
  IF ~~ THEN REPLY @321 /* #74560 */ GOTO 156
END

IF ~~ THEN BEGIN 156 // from: 155.0
  SAY @322 /* #74561 */
  IF ~~ THEN REPLY @323 /* #74562 */ GOTO 157
  IF ~~ THEN REPLY @324 /* #75317 */ GOTO 158
END
...
IF ~~ THEN BEGIN 158 // from: 156.1
  SAY @326 /* #74565 */
  IF ~~ THEN REPLY @327 /* #75318 */ GOTO 160
  IF ~~ THEN REPLY @328 /* #74566 */ GOTO 159
  IF ~~ THEN REPLY @329 /* #74567 */ GOTO 157
END

IF ~~ THEN BEGIN 159 // from: 158.1
  SAY @330 /* #74568 */
  IF ~~ THEN REPLY @331 /* #74569 */ GOTO 160
  IF ~~ THEN REPLY @332 /* #75319 */ GOTO 157
END
...
!StateCheck(Player1,STATE_SLEEPING)~ THEN BEGIN 161 // from:
  SAY @334  /* #75321 */
  IF ~~ THEN REPLY @335 /* #74573 */ GOTO 162
  IF ~~ THEN REPLY @336 /* #74574 */ GOTO 162
END

IF ~~ THEN BEGIN 162 // from: 161.1 161.0
  SAY @337 /* #74575 */
  IF ~~ THEN REPLY @338 /* #75322 */ GOTO 163
  IF ~~ THEN REPLY @339 /* #74577 */ GOTO 164
  IF ~~ THEN REPLY @340 /* #74578 */ GOTO 165
END
...
!StateCheck(Player1,STATE_SLEEPING)~ THEN BEGIN 166 // from:
  SAY @344  /* #74582 */
  IF ~~ THEN REPLY @345 /* #74583 */ GOTO 167
  IF ~~ THEN REPLY @346 /* #74584 */ GOTO 168
  IF ~~ THEN REPLY @347 /* #74585 */ GOTO 169
  IF ~~ THEN REPLY @348 /* #74586 */ GOTO 171
END
...
IF ~~ THEN BEGIN 168 // from: 166.1
  SAY @350 /* #74588 */
  IF ~~ THEN REPLY @351 /* #74589 */ GOTO 172
END

IF ~~ THEN BEGIN 169 // from: 166.2
  SAY @352 /* #74590 */
  IF ~~ THEN REPLY @353 /* #74591 */ GOTO 170
END
...
!StateCheck(Player1,STATE_SLEEPING)~ THEN BEGIN 173 // from:
  SAY @357  /* #74595 */
  IF ~~ THEN REPLY @358 /* #74596 */ GOTO 174
END
...
IF ~~ THEN BEGIN 175 // from: 174.0
  SAY @360 /* #74598 */
  IF ~~ THEN REPLY @361 /* #75323 */ GOTO 176
END

IF ~~ THEN BEGIN 176 // from: 175.0
  SAY @362 /* #74600 */
  IF ~~ THEN REPLY @363 /* #8796 */ GOTO 177
END
...
IF ~~ THEN BEGIN 178 // from: 177.0
  SAY @365 /* #74602 */
  IF ~~ THEN REPLY @366 /* #74603 */ GOTO 179
  IF ~~ THEN REPLY @367 /* #74604 */ GOTO 180
  IF ~~ THEN REPLY @368 /* #75324 */ GOTO 179
  IF ~~ THEN REPLY @369 /* #74606 */ GOTO 181
END
...
IF ~~ THEN BEGIN 183 // from: 182.0
  SAY @374 /* #74611 */
  IF ~~ THEN REPLY @375 /* #75326 */ GOTO 184
  IF ~~ THEN REPLY @376 /* #75327 */ GOTO 188
  IF ~~ THEN REPLY @377 /* #74614 */ GOTO 192
  IF ~~ THEN REPLY @378 /* #75328 */ GOTO 195
  IF ~~ THEN REPLY @379 /* #75329 */ GOTO 195
END
...
IF ~~ THEN BEGIN 197 // from: 196.0
  SAY @393 /* #74630 */
  IF ~~ THEN REPLY @394 /* #74631 */ GOTO 198
  IF ~~ THEN REPLY @395 /* #74632 */ GOTO 199
  IF ~~ THEN REPLY @396 /* #74633 */ GOTO 200
END
...
!StateCheck(Player1,STATE_SLEEPING)~ THEN BEGIN 201 // from:
  SAY @400  /* #74637 */
  IF ~~ THEN REPLY @401 /* #73528 */ GOTO 204
  IF ~~ THEN REPLY @402 /* #74638 */ GOTO 204
  IF ~~ THEN REPLY @403 /* #20287 */ GOTO 202
END

IF ~~ THEN BEGIN 202 // from: 201.2
  SAY @404 /* #74639 */
  IF ~~ THEN REPLY @405 /* #74640 */ GOTO 203
  IF ~~ THEN REPLY @406 /* #74641 */ GOTO 204
END
...
IF ~~ THEN BEGIN 204 // from: 202.1 201.1 201.0
  SAY @408 /* #74643 */
  IF ~~ THEN REPLY @409 /* #74644 */ GOTO 205
END
...
IF ~~ THEN BEGIN 213 // from: 212.0
  SAY @418 /* #74653 */
  IF ~~ THEN REPLY @419 /* #26991 */ DO ~SetGlobal("TashiaChange","GLOBAL",0)~ GOTO 214
  IF ~~ THEN REPLY @420 /* #74654 */ DO ~SetGlobal("TashiaChange","GLOBAL",0)~ GOTO 215
  IF ~~ THEN REPLY @421 /* #74655 */ DO ~SetGlobal("TashiaChange","GLOBAL",0)~ GOTO 217
  IF ~~ THEN REPLY @422 /* #74656 */ DO ~SetGlobal("TashiaChange","GLOBAL",0)~ GOTO 222
  IF ~~ THEN REPLY @423 /* #74657 */ DO ~SetGlobal("TashiaChange","GLOBAL",0)~ GOTO 217
END
...
IF ~~ THEN BEGIN 215 // from: 213.1
  SAY @425 /* #74659 */
  IF ~~ THEN REPLY @426 /* #74660 */ GOTO 216
  IF ~~ THEN REPLY @427 /* #74661 */ GOTO 217
END
...
IF ~~ THEN BEGIN 217 // from: 222.1 215.1 213.4 213.2
  SAY @429 /* #74663 */
  IF ~~ THEN REPLY @430 /* #74664 */ GOTO 218
  IF ~GlobalLT("TashiaInterestMatch","GLOBAL",5)~ THEN REPLY @431 /* #74665 */ GOTO 219
  IF ~GlobalGT("TashiaInterestMatch","GLOBAL",4)~ THEN REPLY @431 /* #74665 */ GOTO 220
END
...
IF ~~ THEN BEGIN 222 // from: 213.3
  SAY @436 /* #74670 */
  IF ~~ THEN REPLY @437 /* #74671 */ GOTO 223
  IF ~~ THEN REPLY @438 /* #74672 */ GOTO 217
END
...
!StateCheck(Player1,STATE_SLEEPING)~ THEN BEGIN 224 // from:
  SAY @440  /* #74674 */
  IF ~~ THEN REPLY @441 /* #21655 */ GOTO 225
END

IF ~~ THEN BEGIN 225 // from: 224.0
  SAY @442 /* #74675 */
  IF ~~ THEN REPLY @443 /* #74676 */ GOTO 226
  IF ~~ THEN REPLY @444 /* #74677 */ GOTO 232
  IF ~~ THEN REPLY @445 /* #74678 */ GOTO 229
  IF ~~ THEN REPLY @446 /* #74679 */ GOTO 233
END

IF ~~ THEN BEGIN 226 // from: 232.0 225.1 225.0
  SAY @447 /* #74680 */
  IF ~~ THEN REPLY @448 /* #74681 */ GOTO 227
  IF ~~ THEN REPLY @449 /* #74682 */ GOTO 232
END

IF ~~ THEN BEGIN 227 // from: 226.0
  SAY @450 /* #74683 */
  IF ~~ THEN REPLY @451 /* #74684 */ GOTO 228
  IF ~~ THEN REPLY @452 /* #74685 */ GOTO 228
  IF ~~ THEN REPLY @453 /* #74686 */ GOTO 228
END
...
IF ~~ THEN BEGIN 229 // from: 233.0 232.1 228.0 225.2
  SAY @455 /* #74688 */
  IF ~~ THEN REPLY @456 /* #74689 */ GOTO 230
  IF ~~ THEN REPLY @457 /* #74690 */ GOTO 230
END

IF ~~ THEN BEGIN 230 // from: 229.1 229.0
  SAY @458 /* #75332 */
  IF ~~ THEN REPLY @459 /* #75333 */ GOTO 231
  IF ~~ THEN REPLY @460 /* #75334 */ GOTO 231
END
...
IF ~~ THEN BEGIN 232 // from: 226.1
  ...
  IF ~~ THEN REPLY @443 /* #74676 */ GOTO 226
  IF ~~ THEN REPLY @445 /* #74678 */ GOTO 229
  IF ~~ THEN REPLY @463 /* #74696 */ GOTO 233
END
...
IF ~Global("ImoenComment","LOCALS",1)~ THEN BEGIN 238 // from:
  SAY @469 /* #74702 */
  IF ~~ THEN REPLY @470 /* #74703 */ GOTO 241
END
...
IF ~~ THEN BEGIN 274 // from: 273.0
  SAY @511 /* #74739 */
  IF ~~ THEN REPLY @512 /* #74740 */ GOTO 275
  IF ~~ THEN REPLY @513 /* #74741 */ GOTO 275
  IF ~~ THEN REPLY @514 /* #74742 */ GOTO 275
END
...
IF ~~ THEN BEGIN add202
  SAY @526
  IF ~~ THEN REPLY @527 GOTO dizzy1
  IF ~~ THEN REPLY @528 GOTO dizzy2
  IF ~~ THEN REPLY @529 GOTO dizzy3
END
...
IF ~~ THEN BEGIN add204
  SAY @536
  IF ~~ THEN REPLY @537 DO ~SetGlobal("EndangerLovedOne","GLOBAL",16)~ GOTO change1
  IF ~~ THEN REPLY @538 DO ~SetGlobal("EndangerLovedOne","GLOBAL",16)~ GOTO change1
  IF ~~ THEN REPLY @539 DO ~SetGlobal("EndangerLovedOne","GLOBAL",16)~ GOTO change1
END
...
APPEND player1
  IF ~~ THEN BEGIN add1
    SAY @627
    IF ~~ THEN REPLY @628 EXTERN BTASHIA 273
    IF ~~ THEN REPLY @629 EXTERN BTASHIA 273
    IF ~~ THEN REPLY @630 EXTERN BTASHIA 273
  END
...
EXTEND_TOP UDPHAE01 106
  IF ~OR(2)
Global("TashiaRomanceActive","GLOBAL",1)
Global("TashiaRomanceActive","GLOBAL",2)~ THEN REPLY @633 EXTERN UDPHAE01 110
END
